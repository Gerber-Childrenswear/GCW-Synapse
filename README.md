...
6. Uploads `docs/reports/cutover/` as workflow artifacts
7. Optionally posts webhook status with `npm run gtm:notify:takeover`
8. Auto-opens or updates a GitHub issue titled `Takeover readiness regression` when strict checks fail
