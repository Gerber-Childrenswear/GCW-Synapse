...
const hmac = node_crypto_1.default.createHmac("sha256", secret).update(raw).digest("base64");
const webhookId = `replay-${Date.now()}`;
async function main() {
    const response = await axios_1.default.post(endpoint, raw, {
        headers: {
...
//# sourceMappingURL=replayWebhook.js.map